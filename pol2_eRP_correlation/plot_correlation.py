...
def plot_nogg(x,y, fig_name):
    ...
    ax.annotate("Pearson R: {0:.3f}".format(cor), (-0.002, 100))
    ax.plot(x_s, y_s, c='black')
    ax.annotate("{0:.3f}x + {0:.3f}".format(coefficients[0], coefficients[1]), (-0.002, 75))
    plt.tight_layout()
...
def plot_gg(x1,y1, x2, y2, x3, y3, x4, y4, fig_name):
    ...
    print(cor, coefficients)
    ax1.annotate("Pearson R: {0:.3f}".format(cor), (-0.002, 100))
    ax1.plot(x_s, y_s, c='black')
    ax1.annotate("{0:.3f}x + {0:.3f}".format(coefficients[0], coefficients[1]), (-0.002, 75))
    ...
    print(cor, coefficients)
    ax2.annotate("Pearson R: {0:.3f}".format(cor), (-0.002, 100))
    ax2.plot(x_s, y_s, c='black')
    ax2.annotate("{0:.3f}x + {0:.3f}".format(coefficients[0], coefficients[1]), (-0.002, 75))
    ...
    print(cor, coefficients)
    ax3.annotate("Pearson R: {0:.3f}".format(cor), (-0.002, 100))
    ax3.plot(x_s, y_s, c='black')
    ax3.annotate("{0:.3f}x + {0:.3f}".format(coefficients[0], coefficients[1]), (-0.002, 75))
    ...
    print(cor, coefficients)
    ax4.annotate("Pearson R: {0:.3f}".format(cor), (-0.002, 100))
    ax4.plot(x_s, y_s, c='black')
    ax4.annotate("{0:.3f}x + {0:.3f}".format(coefficients[0], coefficients[1]), (-0.002, 75))
