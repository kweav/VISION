...
3) Changed k to beta(2.5, 1) as prior and took e^(S^2) from the likelihood
...
class regress_sampler():
    ...
    def indicator_function(self, tss_i, CREs_within_bool):
        ...
        return np.abs(self.compute_spearmanr(tss_i, CREs_within_adjusted)) >= self.k
